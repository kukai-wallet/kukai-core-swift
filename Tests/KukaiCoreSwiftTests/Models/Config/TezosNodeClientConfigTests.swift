...
class TezosNodeClientConfigTests: XCTestCase {
	...
	func testDefaults() {
		...
		XCTAssert(config1.primaryNodeURL.absoluteString == "https://florence-tezos.giganode.io/", config1.primaryNodeURL.absoluteString)
		...
		XCTAssert(config1.tzktURL.absoluteString == "https://api.florencenet.tzkt.io/", config1.tzktURL.absoluteString)
