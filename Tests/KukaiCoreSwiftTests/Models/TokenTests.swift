...
class TokenTests: XCTestCase {
	...
	func testToken() {
		let token = Token(name: "test1", symbol: "T", tokenType: .fungible, faVersion: .fa1_2, balance: TokenAmount(fromNormalisedAmount: 3, decimalPlaces: 4), thumbnailURI: URL(string: "ipfs://abcdefgh1234"), tokenContractAddress: "KT1abc", nfts: nil)
