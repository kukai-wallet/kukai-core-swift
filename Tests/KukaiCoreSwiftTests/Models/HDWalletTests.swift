...
class HDWalletTests: XCTestCase {
	...
	func testDerivationPaths() {
		let wallet1 = HDWallet(withMnemonic: MockConstants.mnemonic, passphrase: "", derivationPath: MockConstants.hdWallet_non_hardened.derivationPath)
		...
		let wallet2 = HDWallet(withMnemonic: MockConstants.mnemonic, passphrase: MockConstants.passphrase, derivationPath: MockConstants.hdWallet_hardened_change.derivationPath)
