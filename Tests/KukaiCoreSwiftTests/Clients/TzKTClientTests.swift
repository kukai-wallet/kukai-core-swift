...
class TzKTClientTests: XCTestCase {
	...
	func testTransactionHistory() {
		...
		MockConstants.shared.tzktClient.fetchTransactions(forAddress: MockConstants.defaultHdWallet.address) { transactions in
			...
			XCTAssert(groups[0].primaryToken?.tokenContractAddress == "KT1PWx2mnDueood7fEmfbBDKx1D9BAnnXitn", groups[0].primaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[0].primaryToken?.tokenId == nil, groups[0].primaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[0].primaryToken?.balance.normalisedRepresentation == "811", groups[0].primaryToken?.balance.normalisedRepresentation ?? "-")
			XCTAssert(groups[0].secondaryToken?.tokenContractAddress == nil, groups[0].secondaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[0].secondaryToken?.tokenId == nil, groups[0].secondaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[0].secondaryToken?.balance.normalisedRepresentation == "0.107519", groups[0].secondaryToken?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[1].primaryToken?.tokenId == nil, groups[1].primaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[1].primaryToken?.balance.normalisedRepresentation == "3.298723", groups[1].primaryToken?.balance.normalisedRepresentation ?? "-")
			XCTAssert(groups[1].secondaryToken?.tokenContractAddress == nil, groups[1].secondaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[1].secondaryToken?.tokenId == nil, groups[1].secondaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[1].secondaryToken?.balance.normalisedRepresentation == nil, groups[1].secondaryToken?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[4].primaryToken?.tokenContractAddress == nil, groups[4].primaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[4].primaryToken?.tokenId == nil, groups[4].primaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[4].primaryToken?.balance.normalisedRepresentation == nil, groups[4].primaryToken?.balance.normalisedRepresentation ?? "-")
			XCTAssert(groups[4].secondaryToken?.tokenContractAddress == nil, groups[4].secondaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[4].secondaryToken?.tokenId == nil, groups[4].secondaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[4].secondaryToken?.balance.normalisedRepresentation == nil, groups[4].secondaryToken?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[6].primaryToken?.tokenContractAddress == nil, groups[6].primaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[6].primaryToken?.tokenId == nil, groups[6].primaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[6].primaryToken?.balance.normalisedRepresentation == nil, groups[6].primaryToken?.balance.normalisedRepresentation ?? "-")
			XCTAssert(groups[6].secondaryToken?.tokenContractAddress == nil, groups[6].secondaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[6].secondaryToken?.tokenId == nil, groups[6].secondaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[6].secondaryToken?.balance.normalisedRepresentation == nil, groups[6].secondaryToken?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[6].transactions[0].getFaTokenTransferData()?.balance.normalisedRepresentation == "387545563", groups[6].transactions[0].getFaTokenTransferData()?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[6].transactions[1].getFaTokenTransferData()?.balance.normalisedRepresentation == nil, groups[6].transactions[1].getFaTokenTransferData()?.balance.normalisedRepresentation ?? "-")
			...
			XCTAssert(groups[6].transactions[2].getFaTokenTransferData()?.balance.normalisedRepresentation == "435173012223", groups[6].transactions[2].getFaTokenTransferData()?.balance.normalisedRepresentation ?? "-")
			
			// Test FA receive
			XCTAssert(groups[14].hash == "ooetYdtgaC7FTYwfTmWYMHL688ax4vqfcV46MZjXhzQBY7xT9dA", groups[14].hash)
			XCTAssert(groups[14].primaryToken?.tokenContractAddress == "KT1Qm7MHmbdiBzoRs7xqBiqoRxw7T2cxTTJN", groups[14].primaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[14].primaryToken?.tokenId == 2, groups[14].primaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[14].primaryToken?.balance.normalisedRepresentation == "2", groups[14].primaryToken?.balance.normalisedRepresentation ?? "-")
			XCTAssert(groups[14].secondaryToken?.tokenContractAddress == nil, groups[14].secondaryToken?.tokenContractAddress ?? "-")
			XCTAssert(groups[14].secondaryToken?.tokenId == nil, groups[14].secondaryToken?.tokenId?.description ?? "-")
			XCTAssert(groups[14].secondaryToken?.balance.normalisedRepresentation == nil, groups[14].secondaryToken?.balance.normalisedRepresentation ?? "-")
